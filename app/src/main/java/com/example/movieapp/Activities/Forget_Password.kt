...
class Forget_Password : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.container_forget_password)) { v, insets ->
            val systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars())
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom)
            insets
        }

        val dangNhapText: TextView = findViewById(R.id.dang_nhap)
        dangNhapText.setOnClickListener {
            val dangNhapIntent = Intent(this, Login::class.java)
                    ...
                    val options = PhoneAuthOptions.newBuilder(mAuth)
                        ...
                        .setCallbacks(object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            override fun onVerificationFailed(e: FirebaseException) {
                                progressBar.visibility = View.GONE
                                guiMaXacThuc.visibility = View.VISIBLE
                                Toast.makeText(this@Forget_Password, e.message, Toast.LENGTH_SHORT).show()
                            }
